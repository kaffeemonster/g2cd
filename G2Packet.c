...
static bool unimpl_action_p(GCC_ATTR_UNUSED_PARAM(g2_connection_t *, connec), GCC_ATTR_UNUSED_PARAM(g2_packet_t *, source), GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_KHL_TS(g2_connection_t *connec, g2_packet_t *source, GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
	time_t foreign_time;
	time_t local_time;
...
static bool handle_LNI_FW(g2_connection_t *connec, GCC_ATTR_UNUSED_PARAM(g2_packet_t *,source), GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_LNI_HS(g2_connection_t *connec, g2_packet_t *source, GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_LNI_GU(g2_connection_t *connec, g2_packet_t *source, GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_LNI_QK(g2_connection_t *connec, GCC_ATTR_UNUSED_PARAM(g2_packet_t *,source), GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_LNI_V(g2_connection_t *connec, g2_packet_t *source, GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_UPROC(GCC_ATTR_UNUSED_PARAM(g2_connection_t *, connec), GCC_ATTR_UNUSED_PARAM(g2_packet_t *, source), struct list_head * target)
{
	/*
...
static bool handle_UPROD(GCC_ATTR_UNUSED_PARAM(g2_connection_t *, connec), GCC_ATTR_UNUSED_PARAM(g2_packet_t *, source), GCC_ATTR_UNUSED_PARAM(struct list_head *, target))
{
...
static bool handle_G2CDC(GCC_ATTR_UNUSED_PARAM(g2_connection_t *, connec), GCC_ATTR_UNUSED_PARAM(g2_packet_t *, source), struct list_head * target)
{
#ifdef HAVE_DLOPEN
	static void *handle;
	const struct s_data
