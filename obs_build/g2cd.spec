...
%ifarch x86_64
BuildRequires: gcc zlib-devel db-devel lib64db4.7-devel dbus-devel libdbus-1-devel pkgconfig ncurses-devel
%else
BuildRequires: gcc zlib-devel db-devel libdb4.7-devel dbus-devel libdbus-1-devel pkgconfig ncurses-devel
%endif
%else
%if 0%{?mdkversion}
BuildRequires: gcc zlib-devel db-devel dbus-devel libdbus-1-devel pkgconfig ncurses-devel
%else
%if 0%{?suse_version} >= 1000
BuildRequires: gcc zlib-devel db-devel dbus-1-devel pkg-config ncurses-devel
%else
%if 0%{?suse_version} < 1000
BuildRequires: gcc zlib-devel db-devel ncurses-devel
%else
BuildRequires: gcc zlib-devel db-devel dbus-devel pkgconfig ncurses-devel
%endif
%endif
%endif
%endif
