...
} aes_consts GCC_ATTR_ALIGNED(16) =
{
	...
	.ipt  = { 0xC2B2E8985A2A7000ULL, 0xCABAE09052227808ULL,
	          0x4C01307D317C4D00ULL, 0xCD80B1FCB0FDCC81ULL },
	.sbo  = { 0xD0D26D176FBDC700ULL, 0x15AABF7AC502A878ULL,
	          0xCFE474A55FBB6A00ULL, 0x8E1E90D1412B35FAULL },
	.inv  = { 0x0E05060F0D080180ULL, 0x040703090A0B0C02ULL,
	          0x01040A060F0B0780ULL, 0x030D0E0C02050809ULL },
	.sb1  = { 0xB19BE18FCB503E00ULL, 0xA5DF7A6E142AF544ULL,
	          0x3618D415FAE22300ULL, 0x3BF7CCC10D2ED9EFULL },
	.sb2  = { 0xE27A93C60B712400ULL, 0x5EB7E955BC982FCDULL,
	          0x69EB88400AE12900ULL, 0xC2A163C8AB82234AULL },
	...
	.opt  = { 0xFF9F4929D6B66000ULL, 0xF7974121DEBE6808ULL,
	          0x01EDBD5150BCEC00ULL, 0xE10D5DB1B05C0CE0ULL },
};
...
# if HAVE_BINUTILS >= 217
	...
	{.func = (void (*)(void))aes_encrypt_key128_SSSE3, .flags_needed = CFEATURE_SSSE3},
# endif
#endif
...
# if HAVE_BINUTILS >= 217
	...
	{.func = (void (*)(void))aes_ecb_encrypt_SSSE3, .flags_needed = CFEATURE_SSSE3},
# endif
#endif
